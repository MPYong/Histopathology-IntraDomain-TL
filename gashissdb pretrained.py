# -*- coding: utf-8 -*-
"""
Created on Fri Jul 21 22:51:44 2023
...
path_result_save = 'journal 2 experiment\\journal 2 part 1\\gashissdb pretrained results no normalization'
...
path[keyword] = "E:\\yongmingping\\GasHisSDB\\journal 2 experiment\\journal 2 part 2\\gashissdb as pretrained dataset\\160 split rgb 230 here"
...
if patch_size == 160:
    # patch size = 160
    std_preset[keyword] = np.array([[[28.813784, 28.813784, 28.813784]]], dtype=np.float32)
    mean_preset[keyword] = np.array([[[3.243102, 3.243102, 3.243102]]], dtype=np.float32)
